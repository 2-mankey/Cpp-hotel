...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "r57"
  WORKING_DIRECTORY "/home/k/Cpp_Lessons/cmake-build-debug/_deps/inih-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("r57" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: r57")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"r57\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/k/Cpp_Lessons/cmake-build-debug/_deps/inih-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/k/Cpp_Lessons/cmake-build-debug/_deps/inih-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
